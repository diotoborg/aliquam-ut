...
**_Version 2 of @diotoborg/aliquam-ut has been written from scratch and is not compatible with version 1 (see migration)._**

There are two different flavors available to use. Please visit the **documentation** of the links below and pick the one you
prefer.

* The [@diotoborg/aliquam-ut-category-style](./category-style/README.MD) flavor.
* The [@diotoborg/aliquam-ut-log4ts-style](./log4ts-style/README.MD) flavor.

**Node Channel (NEW)**

Supports logging to files and file rollover. Please see [@diotoborg/aliquam-ut-node-channel](./node-channel/README.MD) for details.
...
**Using @diotoborg/aliquam-ut version 1?**

Please visit
[https://github.com/diotoborg/aliquam-ut/tree/release-1.x](https://github.com/diotoborg/aliquam-ut/tree/release-1.x)
for more details. Consider upgrading to the latest version.

**Version 2 of @diotoborg/aliquam-ut is _not_ compatible with version 1**
...
```shell
npm install --save @diotoborg/aliquam-ut  # Core is required for any style
npm install --save @diotoborg/aliquam-ut-category-style
```
...
```typescript
/*--- LogConfig.ts ---*/
import {CategoryProvider, Category} from "@diotoborg/aliquam-ut-category-style";
...
```shell
npm install --save @diotoborg/aliquam-ut  # Core is required for any style
npm install --save @diotoborg/aliquam-ut-log4ts-style
```
...
```typescript
/*--- LogConfig.ts ---*/
import {LogLevel} from "@diotoborg/aliquam-ut";
import {Log4TSProvider, Logger} from "@diotoborg/aliquam-ut-log4ts-style";
